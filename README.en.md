...
Current application version: v3.2.2. Frontend asset revision: v3.2.2.
...
- **v3.2.2 (current):** cleans an item after a bare amount is recognized: “吃了一碗面 30” becomes amount 30 with item “一碗面”, while model and size numbers remain intact.
