...
assert.match(html,/data-ui-version="3\.2"/);
assert.match(html,/id="trip-ribbon-origin"/);
assert.match(source,/function ensureEntryJourneyActions\(\)/);
assert.match(styles,/--alexandrite:#1B6664/);
assert.match(styles,/--lava-falls:#C7463D/);
assert.match(styles,/@media \(min-width:700px\) and \(max-width:991px\)\{/);
assert.match(styles,/\.sheet-header\{position:sticky/);
assert.match(styles,/\.entry-journey-switch \.secondary\{min-height:48px/);
